        ...
        for tag in tags:
            ...
            if overlap_length > 0:
                ...
                if overlap_ratio > 0.5:
                    print("      ✅ VINCULARIA por overlap!")
    else:
        print("   ❌ NÃO encontrado no texto")

        # Tentar fuzzy matching com tags
        print("   🔍 Tentando fuzzy matching...")
        for tag in tags:
            ...
            if mod["alteracao"] in tag_texto:
                ...
                if similarity >= 0.85:
                    print(
                        f"      ✅ Fuzzy match {similarity:.2%} com '{tag['tag_nome']}'"
                    )
                elif similarity >= 0.5:
                    print(
                        f"      ⚠️  Fuzzy match {similarity:.2%} com '{tag['tag_nome']}' (abaixo threshold)"
                    )
