...
class TestNormalizacaoTexto:
    ...
    def test_remove_acentos(self):
        ...
        assert resultado == "sao paulo e demais!"
...
class TestScoreComposto:
    ...
    def test_textos_similares_score_alto(self):
        ...
        score = algoritmo._calcular_score_composto(
            "O contrato é válido", "O contrato e valido"
        )
        assert score >= 85.0
    ...
    def test_textos_diferentes_score_baixo(self):
        ...
        algoritmo = AlgoritmoFuzzyAvancado()
        score = algoritmo._calcular_score_composto(
            "completamente diferente", "xyz abc 123"
        )
        assert score < 50.0
...
class TestCalcularPosicoes:
    ...
    def test_match_exato(self):
        ...
        modificacoes = [
            {"tipo": "INSERCAO", "conteudo": {"novo": "contrato de prestação"}}
        ]
    ...
    def test_match_fuzzy_com_acento(self):
        ...
        modificacoes = [
            {"tipo": "INSERCAO", "conteudo": {"novo": "Clausula de rescisao"}}
        ]
        ...
        modificacoes = [
            {
                "tipo": "INSERCAO",
                "conteudo": {
                    "novo": "cláusula inexistente que definitivamente não existe neste texto"
                },
            }
        ]
...
class TestVincularClausulas:
    ...
    def test_vinculacao_com_overlap(self):
        ...
        modificacoes = [
            {"tipo": "ALTERACAO", "conteudo": {"novo": "conteúdo da primeira"}}
        ]
        ...
        tags = [
            {
                ...
                "posicao_inicio": 12,
                "posicao_fim": 57,
                "texto": "Cláusula 1: Conteúdo importante da cláusula.",
            }
        ]
        modificacoes = [
            {
        ...
        tags = [
            {
                ...
                "posicao_inicio": 0,
                "posicao_fim": 16,
                "texto": "Tag1: Conteúdo 1.",
            },
            {
                "id": "tag2",
                "posicao_inicio": 18,
                "posicao_fim": 36,
                "texto": "Tag2: Conteúdo 2.",
            },
        ]
        modificacoes = [
